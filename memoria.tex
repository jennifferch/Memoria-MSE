...
\thesistitle{Emulador de la placa EDU-CIAA-NXP} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
Este emulador se desarrolló como una plataforma web, disponible \textit{on line}, que posibilita escribir, probar y verificar aplicaciones rápidamente de forma amigable y gratuita, sin la necesidad de contar con el hardware real.

Para la realización de este trabajo fueron fundamentales los conocimientos relacionados al análisis y diseño de software, implementación de \textit{drivers} de dispositivos, planificación y sincronización de tareas, sistemas operativos de tiempo real, desarrollo de aplicaciones sobre Linux, y desarrollo de módulos del kernel. Además de \textit{tests} de calidad del software, planificación y gestión de proyectos.
