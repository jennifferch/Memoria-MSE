...
En el presente proyecto se decidió emular esta biblioteca a nivel de API, es decir, que se utilizó como base la biblioteca existente y se realizarón las implementaciones necesarias para que funcione en la web, en lugar de funcionar en el hardware de un microcontrolador real.
